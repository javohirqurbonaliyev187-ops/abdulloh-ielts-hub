...
const benefits = ["Access to free practice tests", "AI-powered writing feedback", "Personalized study roadmap", "Progress tracking & analytics"];
      ...
      <main className="min-h-[calc(100vh-4rem)] flex">
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-md space-y-8">
            <div className="text-center space-y-2">
              ...
              <h1 className="text-3xl font-display text-foreground">Create Your Account</h1>
              <p className="text-muted-foreground">Start your IELTS journey with Abdulloh today</p>
            </div>
            ...
            <form className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" type="text" placeholder="Enter your name" className="pl-10 h-12"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="password" type={showPassword ? "text" : "password"} placeholder="Create a password" className="pl-10 pr-10 h-12"
              ...
              <Button variant="hero" size="xl" className="w-full">Create Account<ArrowRight className="w-5 h-5 ml-2" /></Button>
            </form>
        ...
        <div className="hidden lg:flex flex-1 bg-primary items-center justify-center p-8">
          <div className="max-w-md space-y-8 text-primary-foreground">
            <div>
              <h2 className="text-3xl font-display mb-4">Join 1,000+ students on their IELTS journey</h2>
              <p className="text-primary-foreground/70">Get instant access to comprehensive IELTS preparation materials and AI-powered feedback.</p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-primary-foreground/10 backdrop-blur">
              <p className="text-lg italic mb-4">"This platform helped me achieve Band 8.5. The AI feedback on my writing was incredibly helpful!"</p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-accent" />
                <div><p className="font-semibold">Sardor K.</p><p className="text-sm text-primary-foreground/70">Achieved Band 8.5</p></div>
              </div>
            </div>
          </div>
        </div>
